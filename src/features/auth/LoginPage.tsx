  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white flex flex-col items-center justify-center p-6">
      ...
      <p className="text-gray-500 text-base mb-12">
        Manage your Tiffin & Mess business with ease
      </p>

      {/* Google Login Button */}
      <button
        onClick={handleGoogleLogin}
        className="w-full max-w-sm bg-white border-2 border-gray-200 text-gray-700 px-6 py-4 rounded-2xl font-semibold hover:bg-gray-50 hover:border-gray-300 transition flex items-center justify-center gap-3 shadow-sm"
      >
